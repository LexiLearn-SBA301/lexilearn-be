...
public interface WorkCharacterService {
    ...
    WorkCharacterResponse createCharacter(
            UUID workId,
            CreateWorkCharacterRequest request
    );

    WorkCharacterResponse updateCharacter(
            UUID characterId,
            UpdateWorkCharacterRequest request
    );

    void deleteCharacter(UUID characterId);

    List<WorkCharacterResponse> reorderCharacters(
            UUID workId,
            ReorderWorkCharactersRequest request
    );
}