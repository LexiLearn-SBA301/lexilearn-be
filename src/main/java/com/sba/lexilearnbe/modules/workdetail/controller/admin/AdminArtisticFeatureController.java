...
@Tag(
        name = "Admin Artistic Feature",
        description = "API quản trị đặc điểm nghệ thuật"
)
public class AdminArtisticFeatureController {
    ...
    public ResponseEntity<ApiResponse<ArtisticFeatureResponse>> createArtisticFeature(
        ...
        ArtisticFeatureResponse result =
                artisticFeatureService.createArtisticFeature(workId, request);
    ...
    public ResponseEntity<ApiResponse<ArtisticFeatureResponse>> updateArtisticFeature(
        ...
        ArtisticFeatureResponse result =
                artisticFeatureService.updateArtisticFeature(featureId, request);
    ...
    @PutMapping("/works/{workId}/artistic-features/order")
    ...
    public ResponseEntity<ApiResponse<List<ArtisticFeatureResponse>>> reorderArtisticFeatures(
        ...
        return ResponseEntity.ok(
                ApiResponse.<List<ArtisticFeatureResponse>>builder()
                        .message("Sắp xếp đặc điểm nghệ thuật thành công")
                        .result(result)
                        .build()
        );
    }
