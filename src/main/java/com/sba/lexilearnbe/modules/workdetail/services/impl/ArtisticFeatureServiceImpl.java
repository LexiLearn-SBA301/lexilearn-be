...
public class ArtisticFeatureServiceImpl implements ArtisticFeatureService {
    ...
    @Override
    @Transactional
    public ArtisticFeatureResponse createArtisticFeature(
            UUID workId,
            CreateArtisticFeatureRequest request
    ) {
    ...
    @Override
    @Transactional
    public ArtisticFeatureResponse updateArtisticFeature(
            UUID featureId,
            UpdateArtisticFeatureRequest request
    ) {
    ...
    @Override
    @Transactional
    public List<ArtisticFeatureResponse> reorderArtisticFeatures(
            UUID workId,
            ReorderArtisticFeaturesRequest request
    ) {
        requireWork(workId);
        List<ArtisticFeature> features =
                artisticFeatureRepository.findAllByWork_IdOrderByDisplayOrderAsc(workId);
        validateReorderIds(
                features.stream().map(ArtisticFeature::getId).collect(java.util.stream.Collectors.toSet()),
